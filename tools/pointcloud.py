...
def pcd_ros_to_o3d(
    ros_pcd, feature_field: str, o3d_device: o3d.core.Device = o3d.core.Device("CPU:0")
) -> o3d.t.geometry.PointCloud:
    """
    Converts a ros_message containing a point cloud into a Open 3D point cloud.

    Args:
        ros_pcd : Point cloud as Datastructure generated from ros message.
        feature_field : Key to identify the feature field, e.g. reflectivity or intensity, used for object detection.
        o3d_device : The device, CPU or GPU, to store the point cloud data.

    Returns:
        o3d_pcd : Point cloud in open 3D Data Format
    ...
    o3d_pcd = o3d.t.geometry.PointCloud(device=o3d_device)
...
# def load_pcd(relative_file_path: str = "ouster_human-sample.pcd") -> o3d.t.geometry.PointCloud:
#     """
...
#     global pcd_counter
#     o3d_pcd = o3d.t.io.read_point_cloud(relative_file_path, format="pcd")
